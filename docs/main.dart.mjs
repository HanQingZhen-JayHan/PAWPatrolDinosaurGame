...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1277: () => globalThis.requestWakeLock(),
      _1278: () => globalThis.releaseWakeLock(),
      _1279: () => globalThis.requestMotionPermission(),
      _1283: (x0,x1) => globalThis.firebase_database.ref(x0,x1),
      _1285: (x0,x1) => globalThis.firebase_database.child(x0,x1),
      _1286: x0 => globalThis.firebase_database.onDisconnect(x0),
      _1289: (x0,x1) => globalThis.firebase_database.set(x0,x1),
      _1290: (x0,x1) => globalThis.firebase_database.update(x0,x1),
      _1296: x0 => globalThis.firebase_database.get(x0),
      _1307: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1307(f,arguments.length,x0,x1) }),
      _1308: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1308(f,arguments.length,x0) }),
      _1309: (x0,x1,x2) => globalThis.firebase_database.onChildAdded(x0,x1,x2),
      ...
      _1312: (x0,x1,x2) => globalThis.firebase_database.onValue(x0,x1,x2),
      ...
      _1315: (x0,x1,x2) => globalThis.firebase_database.onChildRemoved(x0,x1,x2),
      ...
      _1318: (x0,x1,x2) => globalThis.firebase_database.onChildChanged(x0,x1,x2),
      ...
      _1321: (x0,x1,x2) => globalThis.firebase_database.onChildMoved(x0,x1,x2),
      _1322: x0 => x0.call(),
      _1335: x0 => x0.toJSON(),
      _1344: x0 => x0.val(),
      _1345: x0 => x0.toJSON(),
      _1348: (x0,x1) => x0.set(x1),
      _1354: (x0,x1) => globalThis.firebase_database.getDatabase(x0,x1),
      _1374: (x0,x1) => x0.getItem(x1),
      _1376: (x0,x1,x2) => x0.setItem(x1,x2),
      _1377: x0 => ({frequency: x0}),
      _1378: x0 => new Accelerometer(x0),
      _1379: x0 => x0.start(),
      ...
      _1395: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1396: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1397: x0 => globalThis.firebase_core.getApp(x0),
      _1398: () => globalThis.firebase_core.getApp(),
      _1403: x0 => x0.key,
      _1404: x0 => x0.priority,
      _1426: x0 => x0.ref,
      _1432: () => globalThis.firebase_core.SDK_VERSION,
      _1438: x0 => x0.apiKey,
      _1440: x0 => x0.authDomain,
      _1442: x0 => x0.databaseURL,
      _1444: x0 => x0.projectId,
      _1446: x0 => x0.storageBucket,
      _1448: x0 => x0.messagingSenderId,
      _1450: x0 => x0.measurementId,
      _1452: x0 => x0.appId,
      _1454: x0 => x0.name,
      _1455: x0 => x0.options,
      _1456: (x0,x1) => x0.createElement(x1),
      _1457: (x0,x1) => x0.debug(x1),
      _1458: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1458(f,arguments.length,x0) }),
      _1459: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1459(f,arguments.length,x0,x1) }),
      _1460: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1461: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1462: (x0,x1) => x0.createScriptURL(x1),
      _1463: (x0,x1,x2) => x0.createScript(x1,x2),
      _1464: (x0,x1) => x0.appendChild(x1),
      _1465: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1465(f,arguments.length,x0) }),
      _1467: Date.now,
      _1469: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1470: s => {
      ...
      _1472: () => typeof dartUseDateNowForTicks !== "undefined",
      _1473: () => 1000 * performance.now(),
      _1474: () => Date.now(),
      _1475: () => {
      ...
      _1477: () => new WeakMap(),
      _1478: (map, o) => map.get(o),
      _1479: (map, o, v) => map.set(o, v),
      _1480: x0 => new WeakRef(x0),
      _1481: x0 => x0.deref(),
      _1488: () => globalThis.WeakRef,
      _1491: s => JSON.stringify(s),
      _1492: s => printToConsole(s),
      ...
      _1504: Object.is,
      _1505: o => o instanceof Array,
      _1506: (a, i) => a.push(i),
      _1510: a => a.pop(),
      _1511: (a, i) => a.splice(i, 1),
      _1512: (a, s) => a.join(s),
      _1513: (a, s, e) => a.slice(s, e),
      _1516: a => a.length,
      _1518: (a, i) => a[i],
      _1519: (a, i, v) => a[i] = v,
      _1521: o => {
      ...
      _1522: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1524: o => o instanceof Uint8Array,
      _1525: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1526: o => o instanceof Int8Array,
      _1527: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1528: o => o instanceof Uint8ClampedArray,
      _1529: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1530: o => o instanceof Uint16Array,
      _1531: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1532: o => o instanceof Int16Array,
      _1533: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1534: o => o instanceof Uint32Array,
      _1535: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1536: o => o instanceof Int32Array,
      _1537: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1539: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1540: o => o instanceof Float32Array,
      _1541: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1542: o => o instanceof Float64Array,
      _1543: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1544: (t, s) => t.set(s),
      _1545: l => new DataView(new ArrayBuffer(l)),
      _1546: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1548: o => o.buffer,
      _1549: o => o.byteOffset,
      _1550: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1551: (b, o) => new DataView(b, o),
      _1552: (b, o, l) => new DataView(b, o, l),
      _1553: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1554: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1555: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1556: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1557: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1558: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1559: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1560: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1561: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1562: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1563: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1564: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1567: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1568: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1569: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1570: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1571: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1572: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1585: (ms, c) =>
      ...
      _1596: () => new AbortController(),
      _1597: x0 => x0.abort(),
      _1598: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1599: (x0,x1) => globalThis.fetch(x0,x1),
      _1600: (x0,x1) => x0.get(x1),
      ...
      _3121: (x0,x1) => { x0.crossOrigin = x1 },
      _3123: (x0,x1) => { x0.text = x1 },
      _3580: () => globalThis.window,
      _3905: x0 => x0.trustedTypes,
      _3907: x0 => x0.localStorage,
      _4240: x0 => x0.length,
      _6181: x0 => x0.signal,
      _6255: () => globalThis.document,
      _6339: x0 => x0.head,
      _8020: x0 => x0.value,
      _8022: x0 => x0.done,
      _8724: x0 => x0.url,
      _8726: x0 => x0.status,
      _8728: x0 => x0.statusText,
      _8729: x0 => x0.headers,
      _8730: x0 => x0.body,
      _12358: x0 => x0.name,
      _13076: () => globalThis.console,
      _13100: x0 => x0.x,
      _13101: x0 => x0.y,
      _13102: x0 => x0.z,
